import type { CreateStep } from '../CreateExhibitPage';

interface CreateExhibitTabsProps {
    currentStep: CreateStep;
    onStepChange: (step: CreateStep) => void;
}

export const CreateExhibitTabs = ({ currentStep, onStepChange }: CreateExhibitTabsProps) => {
    const steps: { id: CreateStep; label: string }[] = [
        { id: 'basic', label: 'Основное описание' },
        { id: 'upload', label: 'Загрузка материала' },
        { id: 'details', label: 'Детали экспоната' },
    ];
