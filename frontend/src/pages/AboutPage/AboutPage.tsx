                ...
                <div className="flex-1">
                    ...
                    <div className="text-neutral-950 text-lg font-normal leading-6 space-y-4">
                        ...
                        <p>
                            ...
                            проводить онлайн-экскурсии, демонстрировать экспонаты, исторические пространства, 3D-модели
                            и мультимедийные материалы. Такой формат помогает сделать знакомство с историей и культурой
                            более доступным, наглядным и интересным для школьников, студентов и широкой аудитории.
                        </p>
                    </div>
                </div>
